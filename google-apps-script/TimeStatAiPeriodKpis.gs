...
function aiPeriodSectionLabels_() {
  return {
    week: {
      cognitiveLock: "認知鎖死（理想每週 <3 次）",
      switchFail: "切換失靈（理想每週 <3 次）",
      socialDays: "Social 日數（理想每週 <3）",
      negativeRemarks72h: "負面情緒 remark + 過去 72h 脈絡",
      positiveRemarks: "正面情緒 remark highlight",
      vacationDays: "放假日（理想 1–2 日）",
      overWorkDays: "Over work 日（理想 ≤2 且唔連續）",
      sleepAnomalies: "睡眠異常（<6h / >10h；唔應連續 >2 日）",
      meditateDays: "Meditate 日（理想 ≥6）",
      exerciseDays: "運動 ≥30m 日（理想 2–5）",
      weekTheme: "本週主題",
      trueFocus: "真正專注時間（活動 − distraction）",
      comparisons: "連續三週對比",
    },
    month: {
      switchFailDays: "切換失靈日數（理想 ≤4 日／月）",
      overSocialWeeks: "Over social 週（唔應連續兩週）",
      chaosStreak: "Chaos／負面情緒連續日（唔應 ≥3）",
      sleepAnomalies: "睡眠異常（唔應連續兩日）",
      meditateKeep: "Meditate 有冇 keep",
      exerciseGaps: "運動 ≥30m 間隔／休息",
      workOver4h: "Work >4h 日數同分佈",
      workOver6h: "Work ≥6h（唔應連續兩日）",
      tradingOver2h: "Trading >2h（唔應連續兩日）",
      positiveEmotionDays: "正面情緒日數",
      emotionUpsDowns: "情緒 ups and downs",
      monthTheme: "本月主題",
      comparisons: "連續三個月對比",
    },
    quarter: {
      weeklyPassFail: "合格／唔合格星期",
      patternsWeekday: "逢星期幾 pattern",
      placeHabits: "地理位置／生活習慣",
      rhythmRegularity: "生活節奏規律 vs 混亂",
      severeIssues: "較嚴重問題",
      habitChanges: "習慣新增／減少",
      emotionFactors: "影響情緒嘅 factor",
      comparisons: "連續三季對比",
    },
    year: {
      monthlyWorkRest: "每月 Work／Rest",
      passFailTrend: "合格／不合格日趨勢",
      placeEmotion: "地理對生活／情緒",
      changePoints: "改變起點月",
      monthStories: "各月發生咩事",
      comparisons: "連續三年對比",
    },
